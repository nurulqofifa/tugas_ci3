...
<center>  <img src="assets/img/20.jpg" class="img-responsive img-circle margin" style="display:inline" alt="Bird" width="350" height="350">
    ...
    <section class="portfolio" id="portfolio">
      <div class="container-fluid bg-1 text-center">
  <!-- <h3 class="margin">Who Am I?</h3> -->
 <center> <img src="assets/img/19.jpg" class="img-responsive img-circle margin" style="display:inline" alt="Bird" width="350" height="350">
        ...
        <div class="col-md-4">
          <div class="thumbnail">
            <a href="/w3images/lights.jpg" target="_blank">
              <img src="assets/img/3.png" alt="Lights" style="width:100%">
            <!-- <div class="caption">
      ...
      <div class="col-md-4">
        <div class="thumbnail">
          <a href="/w3images/nature.jpg" target="_blank">
            <!-- <img src="assets/img/2.png" alt="Nature" style="width:100%">
          -->   <!-- <div class="caption">
              <p>Lorem ipsum donec id elit non mi porta gravida at eget metus.</p>
            </div> -->
          </a>
      ...
      <div class="col-md-4">
        <div class="thumbnail">
          <a href="/w3images/fjords.jpg" target="_blank">
            <!-- <img src="assets/img/4.jpg" alt="Fjords" style="width:100%">
             --><!-- <div class="caption">
              <p>Lorem ipsum donec id elit non mi porta gravida at eget metus.</p>
            </div> -->
          </a>
    ...
    <footer class="footer text-center">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 mb-5 mb-lg-0">
            <h4 class="text-uppercase mb-4">Nurul.qofifa@gmail.com</h4>
            <ul class="list-inline mb-0">
              <li class="list-inline-item">
                <a class="btn btn-outline-light btn-social text-center rounded-circle" href="faceebook.com">
              ...
              <li class="list-inline-item">
                <a class="btn btn-outline-light btn-social text-center rounded-circle" href="twitter.com">
